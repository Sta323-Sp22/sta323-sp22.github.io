---
title: "Lec 12 - Text Processing &<br/>Regular Expressions"
...
knitr::opts_chunk$set(
  cache = FALSE, fig.align = "center" , fig.retina = 2, dpi = 150
)
...
.pull-left[
```{r}
str_detect(text, regex("quick", ignore_case=TRUE))
```
]

.pull-right[
```{r}
str_subset(text, regex("quick", ignore_case=TRUE))
```
]
</div>
...
.footnote[Behold the horror of an old school perl regex for email addresses [here](http://www.ex-parrot.com/~pdw/Mail-RFC822-Address.html)]
