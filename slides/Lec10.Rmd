---
title: "Lec 10 - Visualization with ggplot2"
...
.pull-left[
```{r facet-color-no-legend, fig.show = "hide", warning = TRUE}
ggplot(
  penguins, 
  aes(
    x = bill_depth_mm, 
...
.pull-right[
```{r ref.label = "facet-color-no-legend", echo = FALSE, warning = TRUE, out.width = "95%"}
```
]
