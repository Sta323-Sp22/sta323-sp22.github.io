---
title: "Lec 09 - Functional programming & purrr"
...
We have mentioned in passing that functions in R are treated as 1st class objects (like vectors), meaning they can be assigned names, stored in lists, etc.
